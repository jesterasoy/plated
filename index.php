...
<script>
  ...
  <div class="flex flex-col sm:flex-row gap-6 items-start">
    ...
    <a href="meal.html?name=${encodeURIComponent(meal.strMeal)}" class="text-2xl font-bold mb-5 hover:underline">
      ${meal.strMeal}
    </a>      
...
`;
    ...
    .catch((error) => {
      ...
      randomMeal.innerHTML = "<p class='text-red-500'>Failed to load random meal.</p>";
    });
</script>